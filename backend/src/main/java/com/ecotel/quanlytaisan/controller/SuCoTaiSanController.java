...
@RestController
@RequestMapping("/api/sucotaisan")
public class SuCoTaiSanController {

    @Autowired
    private SuCoTaiSanService service;
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<Object>> create(@RequestBody SuCoTaiSanDTO dto) {
        try {
    ...
    @PostMapping("/batch")
    public ResponseEntity<ApiResponse<Object>> createBatch(@RequestBody List<SuCoTaiSanDTO> list) {
        try {
    ...
    @PutMapping("/batch")
    public ResponseEntity<ApiResponse<Object>> updateBatch(@RequestBody List<SuCoTaiSanDTO> list) {
        try {
