...
public class NhomCCDCService {
    ...
    public PageResponse<NhomCCDC> getAllPaged(String idCongTy, int page, int size, String sortBy, String sortDir, String search) {
        int offset = page * size;
        List<NhomCCDC> items = dao.findAllPaged(idCongTy, offset, size, sortBy, sortDir, search);
