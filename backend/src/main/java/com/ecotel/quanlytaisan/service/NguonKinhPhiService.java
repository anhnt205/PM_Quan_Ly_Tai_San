...
public class NguonKinhPhiService {
    ...
    public PageResponse<NguonKinhPhi> getAllPaged(int page, int size, String sortBy, String sortDir, String search) {
        List<NguonKinhPhi> items = nguonKinhPhiDao.findAllPaged(page, size, sortBy, sortDir, search);
        long totalItems = nguonKinhPhiDao.countAll(search);
