...
public class BanGiaoCCDCVatTu {
    ...
    public static BanGiaoCCDCVatTu mapToBanGiaoCCDCVatTu(String[] row) {
        BanGiaoCCDCVatTu bg = new BanGiaoCCDCVatTu();
        bg.setId(row[0]);
        bg.setIdCongTy(row[1]);
        bg.setBanGiaoCCDCVatTu(row[2]);
    ...
    public static BanGiaoCCDCVatTu mapToBanGiaoCCDCVatTu(Row row) {
        BanGiaoCCDCVatTu bg = new BanGiaoCCDCVatTu();
        bg.setId(getCellStringValue(row.getCell(0)));
        bg.setIdCongTy(getCellStringValue(row.getCell(1)));
        bg.setBanGiaoCCDCVatTu(getCellStringValue(row.getCell(2)));
        ...
        bg.setNgayBanGiao(String.valueOf(row.getCell(7).getLocalDateTimeCellValue()));
        ...
        bg.setTrangThai(parseInteger(String.valueOf(row.getCell(15))));
        bg.setNote(getCellStringValue(row.getCell(16)));
        bg.setNgayTao(String.valueOf(row.getCell(17).getLocalDateTimeCellValue()));
        bg.setNgayCapNhat(String.valueOf(row.getCell(18).getLocalDateTimeCellValue()));
