...
public class NhomTaiSanService {
    ...
    public NhomTaiSanService() {
        nhomTaiSanDao = new NhomTaiSanDao();
    }
    ...
    public PageResponse<NhomTaiSan> getAllPaged(String idCongTy, int page, int size, String sortBy, String sortDir) {
        List<NhomTaiSan> items = nhomTaiSanDao.findAllPaged(idCongTy, page, size, sortBy, sortDir);
        long totalItems = nhomTaiSanDao.countAll(idCongTy);
