...
public class NhanVienDao {
    ...
    public long countByCongTy(String idCongTy, String search) {
        if (search != null && !search.trim().isEmpty()) {
            ...
            String sql = """
                ...
                WHERE nv.IdCongTy = ?
                AND (nv.HoTen LIKE ? OR nv.DiDong LIKE ? OR nv.EmailCongViec LIKE ? 
    ...
    public List<NhanVienDTO> findAllPaged(String idCongTy, int offset, int limit, String sortBy, String sortDir, String search) {
        ...
        if (search != null && !search.trim().isEmpty()) {
            whereClause += " AND (nv.HoTen LIKE ? OR nv.DiDong LIKE ? OR nv.EmailCongViec LIKE ? OR pb.TenPhongBan LIKE ? OR cv.TenChucVu LIKE ?)";
