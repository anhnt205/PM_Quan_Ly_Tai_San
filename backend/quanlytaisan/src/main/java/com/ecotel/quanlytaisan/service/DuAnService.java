...
public class DuAnService {
    ...
    public List<DuAn> getAll(String idCongTy) {
        return duAnDao.findAll(idCongTy);
    }

    public PageResponse<DuAn> getAllPaged(String idCongTy, int page, int size, String sortBy, String sortDir) {
        List<DuAn> items = duAnDao.findAllPaged(idCongTy, page, size, sortBy, sortDir);
        long totalItems = duAnDao.countAll(idCongTy);
