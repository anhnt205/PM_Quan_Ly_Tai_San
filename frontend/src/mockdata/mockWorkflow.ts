...
export const initialAnnualPlans: AnnualPlan[] = [
  ...
  },
  {
    id: 'KH-2025-001',
    year: 2025,
    deviceIds: ['TB-013', 'TB-014', 'TB-015'],
    status: 'cho-duyet',
    createdDate: '2025-01-10',
    description: 'Kế hoạch sửa chữa lớn phòng kỹ thuật 2025',
    sourceDepartmentId: 'PB-02',
    executionDepartmentId: 'PB-05',
  },
  {
    id: 'KH-2025-002',
    year: 2025,
    deviceIds: ['TB-016', 'TB-017', 'TB-018', 'TB-019'],
    status: 'draft',
    createdDate: '2025-02-18',
    description: 'Kế hoạch bảo dưỡng định kỳ thí nghiệm 2025',
  },
  {
    id: 'KH-2026-001',
    year: 2026,
    deviceIds: ['TB-020', 'TB-021', 'TB-022', 'TB-023', 'TB-024'],
    status: 'draft',
    createdDate: '2026-03-05',
    description: 'Kế hoạch sửa chữa/đầu tư thiết bị mới 2026',
  },
  {
    id: 'KH-2026-002',
    year: 2026,
    deviceIds: ['TB-025', 'TB-026'],
    status: 'da-duyet',
    createdDate: '2026-03-25',
    approvedDate: '2026-04-02',
    description: 'Kế hoạch sửa chữa phụ trợ nhà máy 2026',
    sourceDepartmentId: 'PB-03',
    executionDepartmentId: 'PB-06',
  },
  {
    id: 'KH-2023-001',
    year: 2023,
    deviceIds: ['TB-027', 'TB-028', 'TB-029'],
    status: 'da-duyet',
    createdDate: '2023-11-20',
    approvedDate: '2023-11-28',
    description: 'Kế hoạch sửa chữa cuối năm 2023',
  },
];
