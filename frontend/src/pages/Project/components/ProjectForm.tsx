...
import { ProjectBulkValidation } from "../validation/Validation";
...
export default function ProjectForm({
  ...
  const formik = useFormik({
    ...
    validationSchema: ProjectBulkValidation,
    ...
    >
      ...
      >
        <Box display="flex" alignItems="center" gap={1.5}>
          ...
          <Chip
            label={`${formik.values.items.length} dự án`}
            size="small"
                    ...
                    >
                      <Box display="flex" alignItems="center" gap={1}>
                        ...
                        <Typography sx={{ fontWeight: 600, color: "#1FA463" }}>
                          {item.tenDuAn || item.id || `Dự án ${index + 1}`}
                        </Typography>
                      </Box>
                      <Box display="flex" gap={0.5}>
