...
import { TypeAssetBulkValidation } from "../validation/Validation";

export interface TypeAssetItem {
  id: string;
  tenLoai: string;
  idLoaiTs: string;
}

export interface TypeAssetFormProps {
  /** "create" = thêm mới (hiện nút thêm/copy/xóa), "edit" = sửa (ẩn nút thêm/copy) */
  mode: "create" | "edit";
  initialItems?: TypeAssetItem[];
  onSave: (items: TypeAssetItem[]) => void;
  onCancel: () => void;
  onMinimize: () => void;
  onItemsChange?: (items: TypeAssetItem[]) => void;
  initialFormData?: any;
}
...
const normalizeItem = (item: any): TypeAssetItem => ({
  id: item?.id ?? "",
  tenLoai: item?.tenLoai ?? "",
  idLoaiTs: item?.idLoaiTs ?? "",
});
...
export default function TypeAssetForm({
  ...
  const formik = useFormik({
    ...
    validationSchema: TypeAssetBulkValidation,
