...
const AcceptancePreview = ({ row }: Props) => {
  ...
  const groupedMaterials = materialItems.reduce<
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ fontWeight: 400 }}>{row.testResult || "……………………"}</span>
      </Typography>
      <Typography
        variant="caption"
        display="block"
        ...
        {[
          ...
          <Box key={idx} sx={{ flex: 1, textAlign: "center" }}>
            ...
            <Typography
              ...
              display="block"
              sx={{ fontStyle: "italic", mb: 3, fontSize: "0.7rem" }}
            >
              (Ký, ghi rõ họ tên)
            </Typography>
            <Box
