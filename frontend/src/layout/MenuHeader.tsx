import { ArrowRight, KeyboardArrowDown, Logout, ManageAccounts, Person, Settings } from '@mui/icons-material';
...
export default function Menuheader() {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            subMenu: [
                ...
                { text: 'Loại ccdc', path: '/' },
                { text: 'Đơn vị tính', path: '/' },
                { text: 'lý do tăng', path: '/' },
                { text: 'Hiện trạng', path: '/' },
            ]
        },
        {
        ...
        {
            text: 'Điều động tài sản', path: '/',
            subMenu: [
                { text: 'Cấp phát tài sản', path: '/' },
                { text: 'Điều chuyển tài sản', path: '/' },
                { text: 'Thu hồi tài sản', path: '/' }
            ]
        },
        {
            text: 'Điều động CCDC - vật tư', path: '/',
            subMenu: [
        ...
        {
            text: 'Bàn giao tài sản', path: '/',
        },
        {
            text: 'Bàn giao CCDC-Vật tư', path: '/',
        },
        {
            text: 'Báo cáo', path: '/',
            subMenu: [
    ...
    return (
        <Box sx={{ height: '60px', display: 'flex', gap: 3, px: 3, background: 'linear-gradient(to right,rgb(0, 158, 96, 1) 0%,rgb(2, 110, 66, 1) 100%)' }}>
            <Box sx={{
                flexGrow: 1,
                display: 'flex',
            ...
            <Box sx={{ flexGrow: 0 }}>
                <IconButton sx={{ display: 'flex', gap: 2 }} onClick={handleOpenSettingMenu}>
                    <Typography sx={{ color: 'white', fontSize: 18 }}>{user?.username}</Typography>
                    <Avatar src={logo} />
                </IconButton>
                <Menu
                    id="menu-appbar"
                    ...
                    <MenuItem sx={{ borderBottom: '1px solid black', display: 'flex', gap: 2, }}>
                        <ListItemIcon>
